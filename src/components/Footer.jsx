	...
	return (
		<footer className="w-full py-3 px-4 md:px-8 border-t border-foreground/10">
			<div className="max-w-6xl mx-auto">
				...
				{/* Desktop Copyright and Links - Single row with vertical separator */}
				<div className="hidden xs:flex xs:flex-wrap xs:justify-between xs:items-center xs:pt-0 text-xs opacity-50">
					<p>&copy; {currentYear} Giba Daniel. All rights reserved.</p>
